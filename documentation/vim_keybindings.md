 ...
 * [Navigation - NERDTree, EasyMotion, CtrlP and more](documentation/vim/navigation.md)
 * [Text Objects - manipulate ruby blocks, and more](documentation/vim/textobjects.md)
 * [Code manipulation - rails support, comments, snippets, highlighting](documentation/vim/coding.md)
 * [Utils - indents, paste buffer management, lots more](documentation/vim/utils.md)
 * [General enhancements that don't add new commands](documentation/vim/enhancements.md)

A list of some of the most useful commands is included below. This is not a comprehensive list. To get deeper knowledge,
practice a few of these every day, and then start looking into the list of plugins above to learn more.

#### Relevant keyboard remappings

 * **return** is mapped to save the current file if there are any changes.
 * **autocomplete** is mapped to Ctrl-Space

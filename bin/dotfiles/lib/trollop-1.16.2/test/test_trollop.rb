  ...
  module Test
    class Trollop < ::Test::Unit::TestCase
      ...
      def test_wrap
        ...
        assert_equal %w[one two three], @p.wrap('one two three', width: 3)
      ...
      def test_alternate_args
        ...
        physicists_with_humor = %i[alpher bethe gamow]
      ...
      def test_multi_args_autobox_defaults
        ...
        assert_equal %w[hello there], opts[:arg1]
      end
      ...
      def test_ambigious_multi_plus_array_default_resolved_as_specified_by_documentation
        ...
        @p.opt :arg4, 'desc', default: %w[potato rhubarb], short: :none, multi: true

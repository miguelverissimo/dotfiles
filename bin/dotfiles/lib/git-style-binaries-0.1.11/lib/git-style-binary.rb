...
$LOAD_PATH.unshift(File.dirname(__FILE__) + '/../vendor/gems')
  ...
  class << self
    ...
    def load_primary
      unless @loaded_primary
        ...
        unless GitStyleBinary.primary_command # you still dont have a primary load a default
...
at_exit do
  unless $ERROR_INFO || GitStyleBinary.run?
